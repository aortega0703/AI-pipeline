...
\begin{table}
    \begin{tabular}{c|lll}
             & Mountain & Substractive & K-means\\\hline
        DB   & 0.3064 & 0.3701 & 1.1039\\
        Dunn & 0.1516 & 0.1783 & 0.0158
...
\begin{table}
    \begin{tabular}
          & Mountain & Substractive & K-means\\\hline
        DB& 0.3178 & 0.3904 & 1.0164
        Dunn & 0.1618 & 0.1740 & 0.0175
    \end{tabular}
\end{table}
...
\begin{table}
    \begin{tabular}
          & Mountain & Substractive & K-means\\\hline
        DB& 0.2939 & 0.3820 & 1.0651
        Dunn & 0.1574 & 0.1651 & 0.0146
    \end{tabular}
\end{table}
