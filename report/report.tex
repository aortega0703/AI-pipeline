...
\begin{figure*}[ht]
    \includegraphics[width=\linewidth]{sample:hist:attributes}
...
in Figure \ref{fig:dist} by projecting variables $X_1$, $X_2$ and $X_6$ of all
points into the unitary $3d$ cube of the already normalized variables $X_0$,
$X_1$, and $X_2$; the value of the output $Y$ is indicated by colour. The choice
for the plotting axes is made by choosing the most spread out variables.
